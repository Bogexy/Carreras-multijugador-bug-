class Game {
  ...
  start() {
    ...
    cars2.addImage("explocion",blastImage);
    cars1.addImage("explocion",blastImage);
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //guardar los valores de playerLife en currentLife
        var currentLife = allPlayers[prl].life;

        if(currentLife <= 0){
          cars[index-1].changeAnimation("explocion");
